...
set local_dir [pwd]
set src_path ./src
set constraint_path ./src/constraint
...
download_core -vlnv {Microsemi:SolutionCore:mipicsi2rxdecoderPF:4.3.0} -location {www.microchip-ip.com/repositories/DirectCore}
...
download_core -vlnv {Microsemi:SolutionCore:DDR_AXI4_ARBITER_PF:2.0.0} -location {www.microchip-ip.com/repositories/DirectCore}
download_core -vlnv {Microchip:SolutionCore:H264_Iframe_Encoder:1.2.0} -location {www.microchip-ip.com/repositories/DirectCore}
...
source ${src_path}/components/data_packer_h264.tcl
build_design_hierarchy
...
source ${src_path}/components/H264_Iframe_Encoder_C0.tcl
...
source ${src_path}/components/H264_DDR_WRITE.tcl
source ${src_path}/components/h264_top.tcl
source ${src_path}/components/video_processing.tcl
source ${src_path}/components/Video_Pipeline.tcl
source ${src_path}/components/SEVPFSOC_H264.tcl
build_design_hierarchy
