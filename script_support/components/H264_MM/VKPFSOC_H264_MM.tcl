...
# Add MSS instance
sd_instantiate_component -sd_name ${sd_name} -component_name {MSS_VIDEO_KIT_H264_MM} -instance_name {MSS}
...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {MSS:MSS_INT_F2M} -pin_slices {[2:2]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MSS:MSS_INT_F2M[2:2]} -value {GND}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_125MHz" "FIC_CONVERTER_0:ACLK" "MSS:FIC_0_ACLK" "MSS:FIC_1_ACLK" "Video_Pipeline_0:ACLK_I" "Video_Pipeline_0:CLK_125MHz_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:RESETN_125MHz" "FIC_CONVERTER_0:ARESETN" "VSC_8662_RESETN" "Video_Pipeline_0:ARESETN_I" "Video_Pipeline_0:RESETN_125MHz_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"MSS:MSS_INT_F2M[0:0]" "Video_Pipeline_0:INT_DMA_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MSS:MSS_INT_F2M[1:1]" "Video_Pipeline_0:MIPI_INTERRUPT_O" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:AXI4L" "MSS:FIC_0_AXI4_INITIATOR" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:AXI4L_H264" "Video_Pipeline_0:AXI4L_H264" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:AXI4L_IE" "Video_Pipeline_0:AXI4L_IE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:AXI4L_MIPI" "Video_Pipeline_0:AXI4L_MIPI" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:AXI4L_OSD" "Video_Pipeline_0:AXI4L_OSD" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:AXI4L_SCALER" "Video_Pipeline_0:AXI4L_SCALER" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:AXI4L_VDMA" "Video_Pipeline_0:AXI4L_VDMA" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MSS:FIC_1_AXI4_TARGET" "Video_Pipeline_0:mAXI4_SLAVE" }
