...
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {MIPI_TRAINING_LITE} -hdl_file {hdl\MIPI_TRAINING_LITE.v} -instance_name {MIPI_TRAINING_LITE_C0_0}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C0_0:VALID_WIN_LEN_I} -value {00001010}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C0_0:FALSE_FLG_THRESHOLD_I} -value {1010}



# Add MIPI_TRAINING_LITE_C1_0 instance
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {MIPI_TRAINING_LITE} -hdl_file {hdl\MIPI_TRAINING_LITE.v} -instance_name {MIPI_TRAINING_LITE_C1_0}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C1_0:PLL_LOCK_I} -value {VCC}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C1_0:TAP_DELAYS_I} -value {00001010}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C1_0:VALID_WIN_LEN_I} -value {00001010}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C1_0:FALSE_FLG_THRESHOLD_I} -value {1010}



# Add MIPI_TRAINING_LITE_C2_0 instance
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {MIPI_TRAINING_LITE} -hdl_file {hdl\MIPI_TRAINING_LITE.v} -instance_name {MIPI_TRAINING_LITE_C2_0}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C2_0:PLL_LOCK_I} -value {VCC}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C2_0:TAP_DELAYS_I} -value {00001010}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C2_0:VALID_WIN_LEN_I} -value {00001010}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C2_0:FALSE_FLG_THRESHOLD_I} -value {1010}



# Add MIPI_TRAINING_LITE_C3_0 instance
sd_instantiate_hdl_module -sd_name ${sd_name} -hdl_module_name {MIPI_TRAINING_LITE} -hdl_file {hdl\MIPI_TRAINING_LITE.v} -instance_name {MIPI_TRAINING_LITE_C3_0}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C3_0:PLL_LOCK_I} -value {VCC}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C3_0:TAP_DELAYS_I} -value {00001010}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C3_0:VALID_WIN_LEN_I} -value {00001010}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {MIPI_TRAINING_LITE_C3_0:FALSE_FLG_THRESHOLD_I} -value {1010}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:Y" "MIPI_TRAINING_LITE_C0_0:RESET_N_I" "MIPI_TRAINING_LITE_C1_0:RESET_N_I" "MIPI_TRAINING_LITE_C2_0:RESET_N_I" "MIPI_TRAINING_LITE_C3_0:RESET_N_I" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:A" "MIPI_TRAINING_LITE_C0_0:TRAINING_DONE_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:B" "MIPI_TRAINING_LITE_C1_0:TRAINING_DONE_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:C" "MIPI_TRAINING_LITE_C2_0:TRAINING_DONE_O" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND4_0:D" "MIPI_TRAINING_LITE_C3_0:TRAINING_DONE_O" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C1_0:CLK" "MIPI_TRAINING_LITE_C0_0:CLK_I" "MIPI_TRAINING_LITE_C1_0:CLK_I" "MIPI_TRAINING_LITE_C2_0:CLK_I" "MIPI_TRAINING_LITE_C3_0:CLK_I" "PF_IOD_0:RX_CLK_G" "RX_CLK_G" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"L1_LP_DATA_N" "MIPI_TRAINING_LITE_C1_0:LP_DATA_N_I" "PF_IOD_0:L1_LP_DATA_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"L2_LP_DATA" "PF_IOD_0:L2_LP_DATA" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"L2_LP_DATA_N" "MIPI_TRAINING_LITE_C2_0:LP_DATA_N_I" "PF_IOD_0:L2_LP_DATA_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"L3_LP_DATA" "PF_IOD_0:L3_LP_DATA" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"L3_LP_DATA_N" "MIPI_TRAINING_LITE_C3_0:LP_DATA_N_I" "PF_IOD_0:L3_LP_DATA_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C1_0:BIT_ALGN_CLR_FLAGS_O" "PF_IOD_0:EYE_MONITOR_CLEAR_FLAGS[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C1_0:BIT_ALGN_DIRECTION_O" "PF_IOD_0:DELAY_LINE_DIRECTION[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C1_0:BIT_ALGN_LOAD_O" "PF_IOD_0:DELAY_LINE_LOAD[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C1_0:BIT_ALGN_MOVE_O" "PF_IOD_0:DELAY_LINE_MOVE[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C1_0:IOD_EARLY_I" "PF_IOD_0:EYE_MONITOR_EARLY[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C1_0:IOD_LATE_I" "PF_IOD_0:EYE_MONITOR_LATE[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C1_0:IOD_OOR_I" "PF_IOD_0:DELAY_LINE_OUT_OF_RANGE[1:1]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C2_0:BIT_ALGN_CLR_FLAGS_O" "PF_IOD_0:EYE_MONITOR_CLEAR_FLAGS[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C2_0:BIT_ALGN_DIRECTION_O" "PF_IOD_0:DELAY_LINE_DIRECTION[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C2_0:BIT_ALGN_LOAD_O" "PF_IOD_0:DELAY_LINE_LOAD[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C2_0:BIT_ALGN_MOVE_O" "PF_IOD_0:DELAY_LINE_MOVE[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C2_0:IOD_EARLY_I" "PF_IOD_0:EYE_MONITOR_EARLY[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C2_0:IOD_LATE_I" "PF_IOD_0:EYE_MONITOR_LATE[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C2_0:IOD_OOR_I" "PF_IOD_0:DELAY_LINE_OUT_OF_RANGE[2:2]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C3_0:BIT_ALGN_CLR_FLAGS_O" "PF_IOD_0:EYE_MONITOR_CLEAR_FLAGS[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C3_0:BIT_ALGN_DIRECTION_O" "PF_IOD_0:DELAY_LINE_DIRECTION[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C3_0:BIT_ALGN_LOAD_O" "PF_IOD_0:DELAY_LINE_LOAD[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C3_0:BIT_ALGN_MOVE_O" "PF_IOD_0:DELAY_LINE_MOVE[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C3_0:IOD_EARLY_I" "PF_IOD_0:EYE_MONITOR_EARLY[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C3_0:IOD_LATE_I" "PF_IOD_0:EYE_MONITOR_LATE[3:3]" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MIPI_TRAINING_LITE_C3_0:IOD_OOR_I" "PF_IOD_0:DELAY_LINE_OUT_OF_RANGE[3:3]" }
