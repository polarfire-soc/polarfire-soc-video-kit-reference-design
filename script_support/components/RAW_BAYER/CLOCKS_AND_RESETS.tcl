...
sd_create_scalar_port -sd_name ${sd_name} -port_name {RESETN_200MHz} -port_direction {OUT}
...
sd_instantiate_component -sd_name ${sd_name} -component_name {CORERESET_PF_C3} -instance_name {CORERESET_CLK_50MHz}
...
# Add CORERESET_CLK_200MHz instance
sd_instantiate_component -sd_name ${sd_name} -component_name {CORERESET_PF_C6} -instance_name {CORERESET_CLK_200MHz}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_CLK_200MHz:BANK_x_VDDI_STATUS} -value {VCC}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_CLK_200MHz:BANK_y_VDDI_STATUS} -value {VCC}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_CLK_200MHz:SS_BUSY} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {CORERESET_CLK_200MHz:FF_US_RESTORE} -value {GND}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CORERESET_CLK_200MHz:PLL_POWERDOWN_B}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND3_0:A" "PF_CCC_C1_0:PLL_LOCK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND3_0:B" "PF_CCC_C0_0:PLL_LOCK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND3_0:C" "MSS_PLL_LOCKS" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND3_0:Y" "CORERESET_CLK_200MHz:PLL_LOCK" "CORERESET_CLK_50MHz:PLL_LOCK" "CORERESET_PF_C0_0:PLL_LOCK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLK_150MHz" "CORERESET_PF_C0_0:CLK" "PF_CCC_C0_0:OUT1_FABCLK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLK_200MHz" "CORERESET_CLK_200MHz:CLK" "PF_CCC_C1_0:OUT0_FABCLK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLK_50MHz" "CORERESET_CLK_50MHz:CLK" "PF_CCC_C0_0:OUT0_FABCLK_0" "PF_CCC_C1_0:REF_CLK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_CLK_200MHz:EXT_RST_N" "CORERESET_CLK_50MHz:EXT_RST_N" "CORERESET_PF_C0_0:EXT_RST_N" "EXT_RST_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_CLK_200MHz:FABRIC_RESET_N" "RESETN_200MHz" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_CLK_200MHz:FPGA_POR_N" "CORERESET_CLK_50MHz:FPGA_POR_N" "CORERESET_PF_C0_0:FPGA_POR_N" "FABRIC_POR_N" "INIT_MONITOR_0:FABRIC_POR_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_CLK_200MHz:INIT_DONE" "CORERESET_CLK_50MHz:INIT_DONE" "CORERESET_PF_C0_0:INIT_DONE" "DEVICE_INIT_DONE" "INIT_MONITOR_0:DEVICE_INIT_DONE" }
