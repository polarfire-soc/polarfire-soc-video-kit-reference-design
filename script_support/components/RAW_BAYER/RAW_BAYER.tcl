# Creating SmartDesign "DMA_MIPI"
set sd_name {VKPFSoC_RAW_BAYER}
...
sd_create_pin_group -sd_name ${sd_name} -group_name {Group} -instance_name {CLOCKS_AND_RESETS} -pin_names {"XCVR_INIT_DONE" "RESETN_50MHz" "CLK_50MHz" "RESETN_200MHz" "CLK_200MHz" }
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CLOCKS_AND_RESETS:CLK_200MHz}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CLOCKS_AND_RESETS:CLK_50MHz}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CLOCKS_AND_RESETS:RESETN_200MHz}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {CLOCKS_AND_RESETS:RESETN_50MHz}
...
# Add MSS instance
sd_instantiate_component -sd_name ${sd_name} -component_name {MSS_VIDEO_KIT_RAW_BAYER} -instance_name {MSS}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {MSS:MSS_INT_F2M} -pin_slices {[0:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {MSS:MSS_INT_F2M} -pin_slices {[1:1]}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:A" "MSS:FIC_1_DLL_LOCK_M2F" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:B" "MSS:FIC_0_DLL_LOCK_M2F" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND2_0:Y" "CLOCKS_AND_RESETS:MSS_PLL_LOCKS" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_150MHz" "FIC_CONVERTER_0:FIC_CLK" "FIC_CONVERTER_0:MEM_CLK" "MSS:FIC_0_ACLK" "MSS:FIC_1_ACLK" "Video_Pipeline_0:axi_clk_i" "Video_Pipeline_0:ddr_clk_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:RESETN_150MHz" "FIC_CONVERTER_0:FIC_RESETn" "FIC_CONVERTER_0:MEM_RESETN" "VSC_8662_RESETN" "Video_Pipeline_0:axi_clk_rstn_i" "Video_Pipeline_0:ddr_clk_rstn_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"MSS:GPIO_2_M2F_4" "Video_Pipeline_0:TRNG_RST_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MSS:MSS_INT_F2M[0:0]" "Video_Pipeline_0:interrupt_dma" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MSS:MSS_INT_F2M[1:1]" "Video_Pipeline_0:interrupt_mipi" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:AXI4L_DMA_WR" "Video_Pipeline_0:AXI4L_DMA" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:AXI4L_MIPI" "Video_Pipeline_0:AXI4L_MIPI" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:AXI4_Lite" "MSS:FIC_0_AXI4_INITIATOR" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:Arbiter" "Video_Pipeline_0:MASTER_AXI4" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_CONVERTER_0:LPDDR4" "MSS:FIC_1_AXI4_TARGET" }

# Re-enable auto promotion of pins of type 'pad'
auto_promote_pad_pins -promote_all 1
# Save the SmartDesign 
save_smartdesign -sd_name ${sd_name}
# Generate SmartDesign "DMA_MIPI"
