# Creating SmartDesign "VKPFSoC_RAW_BAYER"
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:CLK_150MHz" "FIC_CONVERTER_0:FIC_CLK" "MSS:FIC_0_ACLK" "MSS:FIC_1_ACLK" "Video_Pipeline_0:axi_clk_i" "Video_Pipeline_0:ddr_clk_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLOCKS_AND_RESETS:RESETN_150MHz" "FIC_CONVERTER_0:FIC_RESETn" "VSC_8662_RESETN" "Video_Pipeline_0:axi_clk_rstn_i" "Video_Pipeline_0:ddr_clk_rstn_i" }
...
# Generate SmartDesign "VKPFSoC_RAW_BAYER"
