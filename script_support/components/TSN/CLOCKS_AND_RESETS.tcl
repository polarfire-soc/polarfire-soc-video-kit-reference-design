...
sd_create_scalar_port -sd_name ${sd_name} -port_name {IOD_CDR_PLL} -port_direction {IN}
...
sd_instantiate_component -sd_name ${sd_name} -component_name {CORERESET_PF_C1} -instance_name {CORERESET_CLK_50MHz}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND3_0:A" "MSS_PLL_LOCKS" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND3_0:B" "PF_CCC_C0_0:PLL_LOCK_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND3_0:C" "IOD_CDR_PLL" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"AND3_0:Y" "CORERESET_CLK_125MHz:PLL_LOCK" "CORERESET_CLK_50MHz:PLL_LOCK" }
