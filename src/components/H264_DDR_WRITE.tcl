...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {data_packer_h264_0:buf_wr_done_i} -value {VCC}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {data_packer_h264_0:start_ddr_w_o}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {data_packer_h264_0:s_wlen_o}
